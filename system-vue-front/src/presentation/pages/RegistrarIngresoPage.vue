<script setup lang="ts">
    const openModalAddProducts = () => {
        console.log('openModalAddProducts');
    }
</script>
<template>
    <div class="mb-4 border-bottom">
        <div class="mb-2">
            <router-link to="/system/pedidos" class="btn btn-sm btn-success">
        ...
        <div class="col-lg-8 my-2">
            ...
            <div class="card my-2">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-primary btn-sm" data-target="#addUserModal" data-toggle="modal"
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <input type="text" value="Monitor UltraWide 34' Samsung" readonly
