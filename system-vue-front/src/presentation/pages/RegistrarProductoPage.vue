                        ...
                        <div class="form-group">
                            <div class="custom-file">
                                <input class="custom-file-input"
                                 ref="imagenElement"
                                 type="file"  @change="onChangeImagen">
                                <label class="custom-file-label" for="imagen">
                                    {{ dataForm.nombre ? dataForm.nombre : 'Elegir archivo...' }}
                                </label>
                            </div>
